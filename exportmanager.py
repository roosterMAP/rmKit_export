...
class UIListPanelExportManager(bpy.types.Panel):
	...
	bl_parent_id = "VIEW3D_PT_RMKITEXPORT_PARENT"
...
def export_path( context, object ):
	basePath = bpy.context.preferences.addons[__package__].preferences.export_manager_basepath
...
class OBJECT_OT_ExportManagerSettings(bpy.types.Operator):
	...
	def draw(self, context):
		self.layout.prop( context.preferences.addons[__package__].preferences, 'export_manager_basepath' )
